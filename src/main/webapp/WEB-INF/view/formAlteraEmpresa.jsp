		...
		<form action="${linkEntrdaServlet}" method="post">
			...
			<label for="data">Data</label> <input
				type="text" name="data" value="<fmt:formatDate
					value="${empresa.dataAbertura }" pattern="dd/MM/yyyy" /> " required>	
			<label for="id"></label> <input
				type="hidden" name="id" value="${empresa.id }" class="input-padrao" required>
			<label for="id"></label> <input
				type="hidden" name="acao" value="AlteraEmpresa" class="input-padrao" required>	
